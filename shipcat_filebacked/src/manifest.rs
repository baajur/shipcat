...
pub struct ManifestOverrides {
    ...
    pub secret_files: BTreeMap<String, Option<String>>,
    ...
    pub service_annotations: BTreeMap<String, Option<String>>,
    pub labels: BTreeMap<String, Option<RelaxedString>>,
...
impl Build<Manifest, (Config, Region)> for ManifestSource {
    ...
    fn build(self, (conf, region): &(Config, Region)) -> Result<Manifest> {
        ...
        Ok(Manifest {
            ...
            secretFiles: overrides.secret_files.build(&())?,
            configs: configs,
            ...
            serviceAnnotations: overrides.service_annotations.build(&())?,
